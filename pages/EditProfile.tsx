              ...
              <>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                        <label className="flex items-center gap-2"><input type="radio" name="commission" value="Open" checked={commissionStatus === 'Open'} onChange={(e) => setCommissionStatus(e.target.value)} /> Open</label>
                        <label className="flex items-center gap-2"><input type="radio" name="commission" value="Closed" checked={commissionStatus === 'Closed'} onChange={(e) => setCommissionStatus(e.target.value)} /> Closed</label>
                        <label className="flex items-center gap-2"><input type="radio" name="commission" value="Not Available" checked={commissionStatus === 'Not Available'} onChange={(e) => setCommissionStatus(e.target.value)} /> Not Available</label>
                    </div>
                </div>
